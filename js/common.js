  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: '貸出管理',
        href: 'pages/instrument-lending.html',
...
function renderHeader(options = {}) {
  ...
  header.innerHTML = `
    ...
    <nav class="site-header__nav">
      <span class="nav-badge">SYSTEM</span>
      ${currentUser ? `
        <span style="color:var(--gray-400);font-size:var(--text-sm);margin-left:var(--space-2);">
          ${currentUser.name}
        </span>
      ` : ''}
      <a href="${rootPrefix}pages/auth/login.html" class="header-action-btn" id="logout-btn">
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  renderSidebar({ currentRole: sessionUser?.role || 'all' });
  initMobileMenu();
